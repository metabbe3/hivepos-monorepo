...
import { TrendingUp, ShoppingBag, Building2, Loader2 } from "lucide-react";
...
type TenantSortKey = "rev30d" | "revAll" | "orders30d" | "ordersAll" | "name";
...
function PerformanceInner() {
  ...
  useEffect(() => {
    setLoading(true);
    apiFetch<PerformanceRow[]>(`/api/super-admin/performance?sort=${sort}`)
