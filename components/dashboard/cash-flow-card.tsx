...
export function CashFlowCard({ cashFlow }: CashFlowCardProps) {
  ...
  const chartData = [
    { name: t("dashboard.income"), value: income, fill: "var(--color-secondary)" },
    { name: t("dashboard.expenses"), value: expenses, fill: "var(--color-danger)" },
    {
      name: t("dashboard.netCashFlow"),
      value: net,
      fill: net >= 0 ? "var(--color-secondary)" : "var(--color-danger)",
    },
    {
