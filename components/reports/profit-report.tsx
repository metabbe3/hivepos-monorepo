...
export function ProfitReport({ from, to }: ProfitReportProps) {
  ...
  const summaryCards = [
    { title: t("common.revenue"), value: formatCurrency(summary.revenue), icon: TrendingUp, iconColor: "text-emerald-600", iconBg: "bg-emerald-100 dark:bg-emerald-900/30"},
    { title: t("reporting.expenses"), value: formatCurrency(summary.expenses), icon: TrendingDown, iconColor: "text-rose-600", iconBg: "bg-rose-100 dark:bg-rose-900/30"},
    { title: t("profitReport.netProfit"), value: formatCurrency(summary.netProfit), icon: DollarSign, iconColor: isProfit ? "text-emerald-600" : "text-red-600", iconBg: isProfit ? "bg-emerald-100 dark:bg-emerald-900/30" : "bg-red-100 dark:bg-red-900/30"},
    { title: t("profitReport.margin"), value: `${summary.marginPercent.toFixed(1)}%`, icon: Percent, iconColor: "text-amber-600", iconBg: "bg-amber-100 dark:bg-amber-900/30"},
  ];
