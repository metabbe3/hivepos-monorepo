...
function ItemCard({ item }: { item: TrackingItem }) {
 ...
 <p className="text-xs font-bold text-slate-600">Detail Item</p>
...
export default function TrackOrderPage() {
 ...
 <p className="text-[11px] opacity-60 mb-0.5">Nomor Pesanan</p>
 ...
 <p className="text-xs font-bold text-slate-700 mb-2">Riwayat</p>
                <div className="space-y-2">
 ...
 <p className="text-xs font-bold text-slate-600 mb-1.5">Ketentuan</p>
