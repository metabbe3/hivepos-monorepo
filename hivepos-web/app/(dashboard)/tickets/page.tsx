...
const FAQ_SECTIONS: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: "Bagaimana cara menggunakan deposit pelanggan?",
        a: "Buka Pelanggan → detail pelanggan → tab Deposit. Top-up saldo, lalu saat pembayaran pesanan pilih metode Deposit — saldo otomatis terpotong.",
      },
      {
        q: "Bisakah saya menerima pesanan saat offline?",
        a: "Ya. Saat koneksi terputus, pesanan tersimpan lokal di browser. Saat online kembali, pesanan otomatis tersinkron ke server.",
      },
      {
        q: "Bagaimana cara cetak struk pesanan?",
        a: "Buka detail pesanan → klik ikon Printer. Atur ukuran kertas di Pengaturan Printer. Struk bisa langsung dicetak atau disimpan PDF.",
      },
      {
        q: "Apa itu rincian pakaian (garment breakdown)?",
        a: "Saat membuat pesanan, klik item untuk menambah rincian pakaian (kemeja 3, celana 2, dll). Rincian tersimpan per item dan muncul di struk.",
      },
    ],
  },
];
...
const SECTION_TITLES: Record<string, { en: string; id: string }> = {
  ...
  "faq.fitur": { en: "Features", id: "Fitur" },
};
