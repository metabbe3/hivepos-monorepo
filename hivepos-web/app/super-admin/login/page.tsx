...
export default function SuperAdminLoginPage() {
 ...
 <div className="mt-4 inline-flex items-center gap-1.5 rounded-full border border-[var(--color-border)] bg-[var(--color-muted)] px-3 py-1 text-[11px] font-semibold text-[var(--color-muted-foreground)]">
