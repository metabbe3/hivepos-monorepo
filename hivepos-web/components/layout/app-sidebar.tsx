        ...
        return (
          <SidebarMenuItem key={item.href}>
            <SidebarMenuButton
              ...
              className={`group relative rounded-lg transition-colors hover:bg-sidebar-accent/60 ${
            ...
            >
              ...
              <span className={`text-[13px] ${active ? "text-foreground" : "text-muted-foreground group-hover:text-foreground"}`}>
                {t(item.titleKey)}
              </span>
              {item.badge}
            </SidebarMenuButton>
