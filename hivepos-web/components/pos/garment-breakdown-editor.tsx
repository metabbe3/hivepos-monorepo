        ...
        <div className="mt-2 animate-in fade-in-0 slide-in-from-bottom-2 space-y-3 rounded-xl border border-primary/20 bg-brand-light/60 p-3 ring-1 ring-primary/10 dark:border-primary/30 dark:bg-brand-light/10">
            ...
            {filtered.length === 0 ? (
              ...
              sections.map((section, si) => (
                <div key={si} className={si > 0 ? "mt-1" : ""}>
                  {section.labelKey && (
                    <div className="sticky top-0 z-10 bg-brand-light/80 px-1 py-1 text-[11px] font-semibold text-primary/70 backdrop-blur-sm dark:bg-brand-light/20">
                      {t(section.labelKey)}
                    </div>
                  )}
          ...
          {value.length > 0 ? (
            <div className="space-y-2">
              <div className="flex items-center justify-between px-1 text-[11px] font-semibold text-primary/70">
