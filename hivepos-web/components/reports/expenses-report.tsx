...
export function ExpensesReport({ from, to }: ExpensesReportProps) {
  ...
  const summaryCards = [
    { title: t("expensesReport.totalExpenses"), value: formatCurrency(summary.totalExpenses), icon: DollarSign, iconColor: "text-rose-600", iconBg: "bg-rose-100 dark:bg-rose-900/30"},
    { title: t("expensesReport.categories"), value: String(summary.categoryCount), icon: Tag, iconColor: "text-violet-600", iconBg: "bg-violet-100 dark:bg-violet-900/30"},
    { title: t("expensesReport.dailyAverage"), value: formatCurrency(summary.dailyAvg), icon: TrendingDown, iconColor: "text-amber-600", iconBg: "bg-amber-100 dark:bg-amber-900/30"},
  ];
