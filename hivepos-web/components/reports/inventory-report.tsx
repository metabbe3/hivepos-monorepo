...
export function InventoryReport({ from, to }: InventoryReportProps) {
  ...
  const summaryCards = [
    { title: t("inventoryReport.totalItems"), value: String(summary.totalItems), icon: Package, iconColor: "text-teal-600", iconBg: "bg-teal-100 dark:bg-teal-900/30"},
    { title: t("inventoryReport.totalValue"), value: formatCurrency(summary.totalValue), icon: DollarSign, iconColor: "text-amber-600", iconBg: "bg-amber-100 dark:bg-amber-900/30"},
    { title: t("inventoryReport.lowStock"), value: String(summary.lowStockCount), icon: AlertTriangle, iconColor: "text-red-600", iconBg: "bg-red-100 dark:bg-red-900/30"},
    { title: t("inventoryReport.purchases"), value: String(summary.recentPurchases), icon: ShoppingCart, iconColor: "text-emerald-600", iconBg: "bg-emerald-100 dark:bg-emerald-900/30"},
  ];
