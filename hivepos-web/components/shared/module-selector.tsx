      ...
      <DropdownMenuTrigger
        render={
          <button
            ...
            className="group flex items-center gap-1.5 rounded-md px-1.5 py-0.5 -ml-1.5 text-[11px] font-semibold text-muted-foreground transition-colors hover:bg-sidebar-accent/60 hover:text-foreground disabled:opacity-50"
          />
        }
      >
        <span className="text-sm leading-none">{current.emoji}</span>
